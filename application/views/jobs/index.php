	    ...
	    <div class="col-lg-9">
	    	<div class="table-responsive">
	    		...
	    		function Running() {
	    			...
	    			var Selecte = jobs.options[jobs.status].value;
	    		...
	    		<?php echo form_open('jobs/index', 'id="jobs"'); ?>
		    		<select name="status" id="name" onchange='Running()'>
		    			<option value="todo" selected>Todo</option>
		    			<option value="done-owes">Done-Owes</option>
		    			<option value="done-paid">Done-Paid</option>
		    		</select>
	    		</form>
	    		<div>
	    			<?php echo (count($job)); ?>
